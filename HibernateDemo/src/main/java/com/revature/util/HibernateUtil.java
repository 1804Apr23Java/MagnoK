...
public class HibernateUtil {
	...
	private static SessionFactory getSessionFactory(String filename) {
		...
		if (HibernateUtil.sessionFactory == null) {
			...
			c.setProperty("hibernate.connection.username", System.getenv("MYDB_USERNAME"));
			c.setProperty("hibernate.connection.password", System.getenv("MYDB_PASSWORD"));
			c.setProperty("hibernate.connection.url", System.getenv("MYDB_URL"));
