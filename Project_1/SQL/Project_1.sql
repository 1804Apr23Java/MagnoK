...
CREATE TABLE EMPLOYEE_REIMBURSEMENTS (
    ...
    REIMBURSEMENTS_MANAGERID INTEGER DEFAULT -1,
...
-- ADDING UNIQUE CONSTRAINTS (USERNAME AND EMAIL)
ALTER TABLE EMPLOYEE
ADD CONSTRAINT UC_EMPLOYEE_USERNAME UNIQUE(EMPLOYEE_USERNAME);
/

ALTER TABLE EMPLOYEE
ADD CONSTRAINT UC_EMPLOYEE_EMAIL UNIQUE(EMPLOYEE_EMAIL);
/
...
INSERT INTO EMPLOYEE (EMPLOYEE_LASTNAME, EMPLOYEE_FIRSTNAME, EMPLOYEE_USERNAME, EMPLOYEE_PASSWORD, EMPLOYEE_MANAGERSTATUS)
VALUES ('Kevin','Magno','kmagnomanager','p4ssw0rd',1);
